<!-- registry-sync: version=9.5.1; skills=1352; stars=30283; updated_at=2026-04-03T16:35:06+00:00 -->
# 🌌 Antigravity Awesome Skills: 1,352+ Agentic Skills for Claude Code, Gemini CLI, Cursor, Copilot & More

> **Installable GitHub library of 1,352+ agentic skills for Claude Code, Cursor, Codex CLI, Gemini CLI, Antigravity, and other AI coding assistants.**
...
- **Broad coverage with real utility**: 1,352+ skills across development, testing, security, infrastructure, product, and marketing.
...
If you want a faster answer than "browse all 1,352+ skills", start with a tool-specific guide:
